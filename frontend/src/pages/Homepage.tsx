...
export default function Home() {
  ...
  return (
    <div className="relative flex min-h-screen w-full flex-col overflow-x-hidden">
      ...
      <main className="relative z-10 mx-auto flex flex-1 flex-col items-center justify-center max-w-5xl px-4 pt-6 pb-16 sm:px-6 sm:pt-8">
        {/* <main className=" flex flex-1 flex-col items-center justify-center pt-3 pb-8 sm:pb-12"> */}
