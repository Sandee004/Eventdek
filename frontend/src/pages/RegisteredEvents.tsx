    ...
    <div className="relative min-h-[calc(100vh-4rem)] w-full overflow-hidden px-4 py-8 sm:px-8">
      ...
      <div className="relative z-10 mx-auto max-w-5xl px-4 pt-6 pb-16 sm:px-6 sm:pt-8">
        ...
        {!loading && filteredPasses.length === 0 && (
          <div className="card-frame my-12 rounded-2xl border border-border bg-card/85 p-12 text-center shadow-sm backdrop-blur-sm">
                  ...
                  <div className="grid gap-3.5 p-4 sm:grid-cols-[auto_minmax(0,1fr)] items-start">
                    ...
                    <div className="min-w-0 space-y-1">
                      <div className="flex items-center justify-between gap-1">
                        ...
                        <span className="rounded-full bg-going/15 px-2 py-0.5 text-[9px] font-bold uppercase text-going shrink-0">
      ...
      {selectedPass && (
        ...
        >
          <div
            className="w-full max-w-sm rounded-2xl border border-border bg-card p-6 shadow-md space-y-4 text-center"
